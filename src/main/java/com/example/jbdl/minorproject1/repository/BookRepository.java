...
public interface BookRepository extends JpaRepository<Book, Integer> {
    ...
    @Query(value = "select * from book b join author a where b.author_id=a.id where a.authorEmail=?1",nativeQuery = true)
    List<Book> getBookByAuthor(String authorEmail);
